    ...
    ? [
        {
          ...
          color: "#3FD97F",
          title: "کل بازدیدها",
          value: formatNumber(stats.data.totalViews.value),
          growthRate: stats.data.totalViews.growthRate * 100,
        },
        {
          icon: icons.revenue,
          color: "#FF9C55",
          title: "درآمد کل",
          value: formatCurrency(stats.data.totalRevenue.value),
          growthRate: stats.data.totalRevenue.growthRate * 100,
        },
        {
          icon: icons.orders,
          color: "#8155FF",
          title: "کل سفارشات",
          value: formatNumber(stats.data.totalOrders.value),
          growthRate: stats.data.totalOrders.growthRate * 100,
        },
        {
          icon: icons.users,
          color: "#18BFFF",
          title: "کل کاربران",
          value: formatNumber(stats.data.totalUsers.value),
          growthRate: stats.data.totalUsers.growthRate * 100,
        },
      ]
    : [];
